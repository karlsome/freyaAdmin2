  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div className="rounded-3xl border border-outline-variant/15 bg-surface-container-low p-4 text-sm text-on-surface-variant">
        ...
        <div className="grid gap-3">
          ...
          >
            <div className="text-sm font-black text-on-surface">Overwrite</div>
            <div className="mt-1 text-xs text-on-surface-variant">Replace the existing goal with the new quantity.</div>
          </button>
          ...
          >
            <div className="text-sm font-black text-on-surface">Add</div>
            <div className="mt-1 text-xs text-on-surface-variant">Increase the existing goal by the incoming quantity.</div>
          </button>
          ...
          >
            <div className="text-sm font-black text-on-surface">Cancel</div>
            <div className="mt-1 text-xs text-on-surface-variant">Keep the existing goal unchanged.</div>
          </button>
        </div>
      </div>
    </PlannerModalShell>
